...
import uk.ac.swansea.glyph.framework.util.InputHandler;
import uk.ac.swansea.glyph.framework.util.Painter;
import uk.ac.swansea.glyph.state.LoadState;
...
public class GameView extends SurfaceView implements Runnable{
        ...
        holder.addCallback(new Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (currentState == null) {
                    setCurrentState(new LoadState("LoadState"));
                }
                initGame();
            }
    ...
    private void renderGameImage() {
        ...
        if (screen != null) {
            ...
            screen.drawBitmap(gameImage, gameImageSrc, gameImageDst, mPaint);
