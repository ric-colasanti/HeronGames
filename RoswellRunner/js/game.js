...
class StartScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(230, 20, 'Welcome to Roswell runner ', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(180, 60, 'One of the little bods from area 51', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(220, 100, 'Is trying to escape to route 66', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(90, 140, 'Our plucky alien will need some bus fare though !', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(60, 180, 'Help your new chum avoid dangers and collect coins', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(110, 230, 'Give your alien a boost with your spacecraft ', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(190, 270, 'Move your craft with arrow keys', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(150, 320, "But don't let your alien chum fall too far !", {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
        this.add.text(260, 380, 'Click space key to start', {
            fontFamily: 'Luckiest Guy',
            fontSize: '30px'
        });
